...
func _create_pipeline() -> void:
	...
	pipelines[3] = rd.compute_pipeline_create(mbx_rid)
	...
	pipelines[4] = rd.compute_pipeline_create(qjb_rid)
	...
	pipelines[5] = rd.compute_pipeline_create(qj_rid)
	...
	pipelines[6] = rd.compute_pipeline_create(sp_rid)
	...
	pipelines[7] = rd.compute_pipeline_create(mk_rid)
